...
<%@ include file="/WEB-INF/include.jsp"  %>
      ...
      <p ng-show="resourceForm.value.$invalid && !resourceForm.value.$pristine" class="help-block"> is required.</p>
        ...
        <div class="form-group" ng-class="{ 'has-error' : resourceForm.activityDate.$invalid && !resourceForm.activityDate.$pristine }">
      <label for="activityDate" class="control-label">Activity Date</label>   
      <input type="text" id="activityDate" ng-model="resource.activityDate" name="activityDate" required="" class="form-control dateinput" data-provide="datepicker" data-date-format="yyyy-mm-dd" data-date-autoclose="true"/>
      <p ng-show="resourceForm.activityDate.$invalid && !resourceForm.activityDate.$pristine" class="help-block"> is required.</p>
    </div>

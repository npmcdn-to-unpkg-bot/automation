...
<c:url value="/weight/save" var="formActionUrl" />
<c:url value="/weight/list" var="cancelUrl" />

<div class="row">
	<div class="col-xs-12 col-sm-8 col-md-6 col-lg-4">
		<form:form method="post" commandName="weight" action="${ formActionUrl }" role="form">
    		<fieldset>
    			...
    			<legend>Weight</legend>
      			...
      			<spring:bind path="weightInDate">        
	     			<div class="form-group ${status.error ? 'has-error' : ''}">
    					...
    					<form:input path="weightInDate"  class="form-control dateinput" data-provide="datepicker" data-date-format="yyyy-mm-dd" data-date-autoclose="true"/>
    				<form:errors path="weightInDate" class="help-block" element="span" />
    	     			</div>
				</spring:bind>	

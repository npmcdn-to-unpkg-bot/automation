...
<%@ include file="/WEB-INF/include.jsp"  %>
      ...
      <p ng-show="resourceForm.value.$invalid && !resourceForm.value.$pristine" class="help-block"> is required.</p>
        ...
        <div class="form-group" ng-class="{ 'has-error' : resourceForm.weightInDate.$invalid && !resourceForm.weightInDate.$pristine }">
      <label for="weightInDate" class="control-label">Weight In Date</label>   
      <input type="text" id="weightInDate" ng-model="resource.weightInDate" name="weightInDate" required="" class="form-control dateinput" data-provide="datepicker" data-date-format="yyyy-mm-dd" data-date-autoclose="true"/>
      <p ng-show="resourceForm.weightInDate.$invalid && !resourceForm.weightInDate.$pristine" class="help-block"> is required.</p>
    </div>

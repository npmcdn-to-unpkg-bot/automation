...
<c:url value="/heartrate/save" var="formActionUrl" />
<c:url value="/heartrate/list" var="cancelUrl" />

<div class="row">
	<div class="col-xs-12 col-sm-8 col-md-6 col-lg-4">
		<form:form method="post" commandName="heartRate" action="${ formActionUrl }" role="form">
    		<fieldset>
    		
    			<legend>Heart Rate</legend>
   
    
  				<form:hidden path="heartRateId" />
      			...
      			<spring:bind path="measureDate">        
	     			<div class="form-group ${status.error ? 'has-error' : ''}">
	      				<label for="measureDate" class="control-label">Measure Date</label>
    					<form:input path="measureDate"  class="form-control dateinput" data-provide="datepicker" data-date-format="yyyy-mm-dd" data-date-autoclose="true"/>
    				<form:errors path="measureDate" class="help-block" element="span" />
    	     			</div>
				</spring:bind>	
